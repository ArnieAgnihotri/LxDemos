  ...
  return (
    <div className="min-h-screen bg-black pb-20 pt-20 text-white">
      <div className="container mx-auto px-4">
        ...
        <p className="mb-8 text-gray-300">Last updated: March 23, 2024</p>

        <div className="prose prose-invert max-w-none">
          <h2>1. Acceptance of Terms</h2>
          <p>
            By accessing or using LxDemos ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you
            disagree with any part of the Terms, you may not access the Service.
          </p>

          <h2>2. Description of Service</h2>
          <p>
            LxDemos is a platform for discovering, sharing, and trying Linux configurations in real-time. The Service
            includes a website, real-time terminal emulator, and configuration library.
          </p>
          ...
          <p>
            ...
            graphics, or other material ("Content"). You are responsible for the Content that you post to the Service,
          ...
          <h2>5. Terminal Emulator Use</h2>
          <p>
            The terminal emulator provided by the Service is intended for legitimate testing of Linux configurations.
            You agree not to use the terminal emulator for any illegal or harmful activities, including but not limited
            to:
          </p>
          <ul>
            <li>Attempting to gain unauthorized access to any systems</li>
            <li>Launching attacks on other systems or networks</li>
            <li>Running resource-intensive operations designed to disrupt service</li>
            <li>Executing malicious code or malware</li>
            <li>Violating any applicable laws or regulations</li>
          </ul>
          <p>
            We reserve the right to monitor terminal usage and terminate access for users who violate these conditions.
          </p>

          <h2>6. Intellectual Property</h2>
          <p>
            The Service and its original content (excluding Content provided by users), features and functionality are
            and will remain the exclusive property of LxDemos and its licensors. The Service is protected by copyright,
            trademark, and other laws of both the United States and foreign countries. Our trademarks and trade dress
            may not be used in connection with any product or service without the prior written consent of LxDemos.
          </p>
          ...
          <p>
            LxDemos has no control over, and assumes no responsibility for, the content, privacy policies, or practices
            of any third party web sites or services. You further acknowledge and agree that LxDemos shall not be
          ...
          <p>
            In no event shall LxDemos, nor its directors, employees, partners, agents, suppliers, or affiliates, be
          ...
          <h2>13. Contact Us</h2>
          <p>If you have any questions about these Terms, please contact us at terms@lxdemos.com.</p>
        </div>
      </div>
    </div>
  )
